...
Lecode.S_TBS.Config.Sequences = {
    ...
    * Your Sequences
	...
	"mapaoe_enemies_with_atk_anime": [
        "call: pre-skill",
        "map_anim: cursor_cell, obj_anim",
		"map_effects: {aoe}_enemies, current_obj, 121",
        "call: post-skill"
    ],
	
	"mapaoe_enemies_without_atk_anime": [
        "call: cast(loop)",
        "map_anim: cursor_cell, obj_anim",
        "effects: {aoe}_enemies, current_obj, 121",
        "call: post-skill"
    ],
	
	"aoe_enemies_without_atk_anime": [
        "call: cast(loop)",
        "map_anim: {aoe}_enemies, obj_anim",
        "effects: {aoe}_enemies, current_obj, 121",
        "call: post-skill"
    ],
	
	"aoe_enemies_with_atk_anime": [
        "call: pre-skill",
        "anim: {aoe}_enemies, obj_anim",
